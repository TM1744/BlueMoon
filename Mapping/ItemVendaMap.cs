...
namespace BlueMoon.Mapping
{
    public class ItemVendaMap : IEntityTypeConfiguration<ItemVenda>
    {
        public void Configure(EntityTypeBuilder<ItemVenda> builder)
        {
            ...
            builder.Property(x => x.ProdutoMarca).HasColumnName("produto_marca").HasMaxLength(50).IsRequired();
            builder.Property(x => x.ProdutoCodigo).HasColumnName("produto_codigo").IsRequired();
