...
namespace BlueMoon.Mapping
{
    public sealed class PessoaMap : IEntityTypeConfiguration<Pessoa>
    {
        public void Configure(EntityTypeBuilder<Pessoa> builder)
        {
            ...
            builder.Property(x => x.InscricaoMunicipal).HasColumnName("inscricao_municipal").HasMaxLength(12).IsRequired();
            builder.Property(x => x.InscricaoEstadual).HasColumnName("inscricao_estadual").HasMaxLength(13).IsRequired();
            builder.Property(x => x.CEP).HasColumnName("cep").HasColumnType("char(8)").IsRequired();
            ...
            builder.Property(x => x.Complemento).HasColumnName("complemento").HasMaxLength(40).IsRequired();
